...
:maxdepth: 1
:caption: Notebooks 📖
notebooks/P0/01_example_notebook_interactive.ipynb
notebooks/P0/02_example_with_dependencies.ipynb
notebooks/P0/03_public_repo_summary_charts.ipynb
```
...
dataframes/P0/compa.md
dataframes/P0/crsp_m.md
dataframes/P0/ff_factors.md
dataframes/P0/fred.md
dataframes/P0/ibes_forecast.md
```
...
Replication of van Binsbergen, Han, and Lopez-Lira (2022)
